import { Box, Flex, Heading, Button, Icon, Table,Thead, Tbody, Td, Tr, Th, Checkbox, Text } from "@chakra-ui/react";
                        ...
                        <Tr>
                            ...
                            <Td>
                                <Button 
                                    ...
                                    fontSize="sm" 
                                    colorScheme="purple"
                                    leftIcon={<Icon as={RiPencilLine} fontSize="20"/> }>Editar</Button>
                            </Td>
                        </Tr>
                    </Tbody>
                </Table>
